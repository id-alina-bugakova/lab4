...
<SwConfiguration CpuAddress="SL1" xmlns="http://br-automation.co.at/AS/SwConfiguration">
  ...
  <TaskClass Name="Cyclic#4">
    <Task Name="drive_prog" Source="drive_program.prg" Memory="UserROM" Language="ANSIC" Debugging="true" />
    <Task Name="led_progra" Source="led_program.prg" Memory="UserROM" Language="ANSIC" Debugging="true" />
  </TaskClass>
  <NcDataObjects>
  ...
  <Libraries>
    ...
    <LibraryObject Name="Drive_lib" Source="Libraries.Drive_lib.lby" Memory="UserROM" Language="ANSIC" Debugging="true" />
  </Libraries>
</SwConfiguration>